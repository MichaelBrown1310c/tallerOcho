...
public class puntosCard{
String suit,name;
int points;

puntosCard(int n1, int n2){
...
puntosCard newCard = new puntosCard(suitNumber,faceNumber);
...
suitNumber = (int)(Math.random()*4.0+1);
faceNumber = (int)(Math.random()*13.0+1);
puntosCard newCard2 = new puntosCard(suitNumber,faceNumber);
...
suitNumber = (int)(Math.random()*4.0+1);
faceNumber = (int)(Math.random()*13.0+1);
newCard2 = new puntosCard(suitNumber,faceNumber);
System.out.println(newCard2);
